-- LocalScript: IEEF HUB Mini Menu with KeySystem v4
...
CheckBtn.Position = UDim2.new(0.05,0,0,85)
...
DiscordBtn.Size = UDim2.new(0.38,0,0,30)
DiscordBtn.Position = UDim2.new(0.57,0,0,85)
