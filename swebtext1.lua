-- LocalScript: IEEF HUB Mini Menu with KeySystem v2
...
-- Key Input Box (clean, same style as buttons)
...
KeyBox.Text = ""
KeyBox.PlaceholderText = "" -- no default text
...
-- Check Key Button (same style as main menu buttons)
local CheckBtn = Instance.new("TextButton")
CheckBtn.Size = UDim2.new(0.8,0,0,30)
CheckBtn.Position = UDim2.new(0.1,0,0,85)
...
-- Discord Button (same style as main menu buttons)
local DiscordBtn = Instance.new("TextButton")
DiscordBtn.Size = UDim2.new(0.8,0,0,30)
DiscordBtn.Position = UDim2.new(0.1,0,0,125)
DiscordBtn.BackgroundColor3 = Color3.fromRGB(0,0,200)
...
MainFrame.Visible = false -- hidden until key is correct
