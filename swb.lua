-- LocalScript: IEEF HUB Mini Menu with KeySystem v3
...
KeyBox.Text = ""
KeyBox.PlaceholderText = "" -- no placeholder text
...
-- Check Key Button (green, same as main menu style)
...
-- Discord Button (red, same style as main menu buttons)
