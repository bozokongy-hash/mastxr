-- LocalScript: IEEF HUB Mini Menu with KeySystem
...
local VALID_KEY = "SWEB123" -- example key, you can change it
...
CheckBtn.Position = UDim2.new(0.1,0,0,75)
...
DiscordBtn.Position = UDim2.new(0.55,0,0,75)
...
-- Apply speed if character already exists
